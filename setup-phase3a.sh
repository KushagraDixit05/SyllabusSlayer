...
echo "       Then run /supabase/migrations/phase3c-gamification.sql"
...
echo "[ ] 7. Run: npm run dev  (from project root — starts both servers)"
echo "[ ] 8. Visit: http://localhost:3000/auth/signin"
echo "[ ] 9. Complete the onboarding tour after first sign-in"
echo ""
